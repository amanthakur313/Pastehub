...
const Home = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-white dark:bg-gray-900 shadow-lg rounded-2xl transition-all duration-300">
      <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">📝 {pasteId ? "Update Your Paste" : "Create a New Paste"}</h2>
